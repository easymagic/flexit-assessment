  ...
  return (
    <div className="bg-gray-100 h-screen">
      <div className="container flex mx-auto">
        {/* left side bar */}
        <div className="p-2 border-r-2 w-1/6 border-color-gray-300 h-screen flex flex-col">
          <div className="mt-5">
            Bluecube
          </div>
          <div>
...
{/* start nav */}
<div class="navbar mb-2 shadow-lg bg-white text-neutral-content rounded-box">
          ...
          <div className="w-full flex flex-row mt-3">
            ...
            <div className="w-5/6 p-3">
              ...
              <div className="p-3 shadow rounded bg-white flex">
                <img src={searchIcon} className="flex-shrink w-12 h-7 top-1 relative left-1" />
